...
#pylab.plot(x, y1, "r-")
pylab.hist(histo_data, bins=100, normed=True, label='simulation')
pylab.plot(list_x, list_y, "r-", label='simulation', linewidth=2)
pylab.plot(t, y_quant, "b--", label='quantum mechanical', linewidth=2)
pylab.xlabel('x')
pylab.ylabel('pi^2')
pylab.legend()
